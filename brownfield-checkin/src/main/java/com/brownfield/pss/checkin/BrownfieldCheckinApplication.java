...
public class BrownfieldCheckinApplication implements CommandLineRunner {
	private static final Logger logger = LoggerFactory.getLogger(BrownfieldCheckinApplication.class);
