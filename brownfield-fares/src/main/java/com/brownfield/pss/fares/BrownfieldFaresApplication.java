...
public class BrownfieldFaresApplication implements CommandLineRunner {
	private static final Logger logger = LoggerFactory.getLogger(BrownfieldFaresApplication.class);

	@Autowired
	FaresRepository faresRepository;
	
	public static void main(String[] args) {
		SpringApplication.run(BrownfieldFaresApplication.class, args);
	}
